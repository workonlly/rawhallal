...
export async function generateMetadata() {
  ...
  const product = {
    id: data?.id || 'title',
    name: data?.title || 'Fresh Chicken Products',
    description: data?.metadata || 'Fresh and halal chicken products from Raw Halal Chicken.',
    keywords: Array.isArray(data?.metakeywords) ? data.metakeywords : ['chicken', 'fresh', 'halal', 'products'],
...
export default async function PageContent() {
  ...
  const pageHeading = data?.heading || 'Fresh Chicken Products';
