...
export async function generateMetadata() {
  ...
  const product = {
    id: data?.id || 'title',
    name: data?.title || 'Fresh Mutton Products',
    description: data?.metadata || 'Fresh and halal mutton products from Raw Halal Chicken.',
    keywords: Array.isArray(data?.metakeywords) ? data.metakeywords : ['mutton', 'fresh', 'halal', 'products'],
...
export default async function PageContent() {
  ...
  const pageHeading = data?.heading || 'Fresh Mutton Products';
